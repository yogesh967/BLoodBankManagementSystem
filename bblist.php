...
<html lang="en">
  <head>
    ...
    <title>blood Bank list | Life Source Blood Bank</title>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item active" href="bblist.php">Blood Bank List</a>
            ...
            <div class="table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button name="view_btn" class="btn bg-transparent text-primary" data-toggle="modal" data-target="#myModal<?php echo $row['ID']; ?>">
                      View Details
                    </button>
