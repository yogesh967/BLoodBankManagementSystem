...
header('location:../login.php');
  ...
  $fetch = mysqli_fetch_array($fire_bloodbank);
	...
	$hash = "edd641ec432cfc96b09da62029d51f8f4181487a47c4dec20860b1cb7e0caaf2";
		...
		$message = "Hi $name, I am from $bbname. We'd love you to see you again to help maintain stocks of your blood group. \nPlease visit \nAdd: $address $state $city \nContact: $contact. \nThank You!!";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Request Donor to Donate Blood</h2>

						<!-- Zero Configuration Table -->
						<div class="card">
							<div class="card-header">Donor List</div>
							<div class="card-body">
                ...
                <div class="table-responsive">
									...
									<?php
									$query = "SELECT * from register WHERE status='1' ORDER BY ID DESC";
			                      ...
			                      <div class="modal-content">
			                        ...
			                        <div class="modal-footer">
			                          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
										...
										<td>
											<form name="update_donor" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
											<input type="hidden" name="donor_id" value="<?php echo $row['ID']; ?>">
											<input type="submit" name="request_btn" onclick="return confirm('Do you really want to send message')" class="btn btn-primary" value="Request" />
											</form>
										</td>
										</tr>
										<?php
