...
header('location:index.php');
  ...
  $query1 = "UPDATE register SET name='$name', password='$password', email='$email', birth='$birth', age='$age', gender='$gender', weight='$weight', bgroup='$bgroup', phone='$phone', mobile='$mobile', address='$address', State='$state', city='$city' WHERE ID='$id'";
  $query_run1 = mysqli_query($conn,$query1);

  if ($query_run1) {
    $_SESSION['success'] = "Your data is updated";
    header("location:update-donor.php");
  }
                            ...
                            <tbody>
                              <tr>
					                      ...
					                      <input type="text" class="form-control" name="birth" value="<?php echo $row['birth']; ?>" />
					                        ...
					                        <input type="text" class="form-control" name="age" id="age" value="<?php echo $row['age']; ?>" placeholder="0" readonly />
...
function Validate_uregister() {
						...
						var age = document.forms["update_register"]["age"];
