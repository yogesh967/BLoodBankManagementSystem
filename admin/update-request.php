      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">Patient Request List</div>
              <div class="card-body">
								<?php
                ...
                <div class="table-responsive">
                  ...
                  <?php
                  $query = "SELECT * from requestblood ORDER BY ID DESC";
                ...
                <table id="zctb" class="table table-bordered table-striped" cellspacing="0" width="100%">
                 ...
                 <tbody>
                   <?php
                      ...
                      <td>
  											<form name="update_donor" action="update-rform.php" method="post">
