...
$sql = "UPDATE bbregister SET Status=:status WHERE ID=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query-> bindParam(':aeid',$aeid, PDO::PARAM_STR);
$query -> execute();

$msg="Blood Bank activated Successfully";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Blood Bank Request</h2>
                ...
                <table id="zctb" class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">
                  ...
                  <?php $sql = "SELECT * from bbregister WHERE status=0 ORDER BY ID DESC";
                  $query = $dbh -> prepare($sql);
                  $query->execute();
                  ...
                  {				?>
										<tr>
											...
											<td><?php echo htmlentities($result->cpname);?></td>
											<td>
			                      ...
			                      <div class="modal-content">
			                        ...
			                        <div class="modal-body" style="text-align:left;">
																<table class="table table-bordered">
																	...
																	<tr>
																		<td>Fax No.</td>
																		<td><?php echo htmlentities($result->faxno); ?></td>
																	</tr>
																	<tr>
																		<td>license No.</td>
																	...
																	<tr>
																		...
																		<td><?php echo htmlentities($result->apheresis); ?></td>
																	</tr>
																	<tr>
																		<td>Helpline</td>
																		<td><?php echo htmlentities($result->helpline); ?></td>
																	</tr>
																	<tr>
																		<td>Website</td>
																	...
																	<tr>
																		<td>Certificate</td>
																		<td><a href="../images/certificate/<?php echo htmlentities($result->certificate);?>" target="_blank"><?php echo htmlentities($result->certificate);?></td>
																	</tr>
																	<tr>
																		<td>State</td>
                      ...
                      <?php if($result->status==0)
											...
											<a href="bb-request.php?public=<?php echo htmlentities($result->ID);?>" onclick="return confirm('Do you really want to Activated this account')" class="btn btn-primary">Active</a>
											<?php } ?>
											</td>
