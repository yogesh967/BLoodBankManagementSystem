...
$status="0";
$sql = "UPDATE register SET Status=:status WHERE ID=:eid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query-> bindParam(':eid',$eid, PDO::PARAM_STR);
$query -> execute();

$msg="Donor Hidden Successfully";
}
...
$msg="Donor public Successfully";
}
if(isset($_REQUEST['del']))
	{
$did=intval($_GET['del']);
$sql = "DELETE from register WHERE ID=:did";
$query = $dbh->prepare($sql);
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">Donors Info</div>
							<div class="card-body">
                ...
                <table id="zctb" class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">
                  ...
                  <?php $sql = "SELECT * from register ORDER BY ID DESC";
                  $query = $dbh -> prepare($sql);
                  $query->execute();
                  ...
                  {				?>
										<tr>
											...
											<td><?php echo htmlentities($result->birth);?></td>
			                        ...
			                        <div class="modal-body" style="text-align:left;">
																<table class="table table-bordered">
																	...
																	<tr>
																		...
																		<td><?php echo htmlentities($result->donated_date); ?></td>
																	</tr>
																</table>
			                        </div>
			                        <!-- Modal footer -->
                      ...
                      <?php if($result->status==1)
											...
											<a href="donor-list.php?hidden=<?php echo htmlentities($result->ID);?>" onclick="return confirm('Do you really want to hiidden this detail')" class="btn btn-primary btn-sm mb-2">Hidden</a><br />
											<?php } else {?>

											<a href="donor-list.php?public=<?php echo htmlentities($result->ID);?>" onclick="return confirm('Do you really want to Public this detail')" class="btn btn-success btn-sm mb-2">Public</a><br />

											<?php } ?>
											<a href="donor-list.php?del=<?php echo htmlentities($result->ID);?>" onclick="return confirm('Do you really want to delete this record')" class="btn btn-danger btn-sm">Delete</a>
											</td>
