...
$sql ="SELECT password FROM admin_user WHERE username=:username and password=:password";
...
if($query -> rowCount() > 0)
{
$con="UPDATE admin_user set password=:newpassword where username=:username";
