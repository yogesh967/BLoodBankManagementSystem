...
header('location:../login.php');
	  ...
	  $id = $_POST['request_id'];
		...
		$donor = "SELECT * FROM register WHERE ID='$id2'";
	  $fire_donor =  mysqli_query($conn,$donor);

	  $fetch = mysqli_fetch_array($fire_donor);
	...
	$message = "Hello $name, I am $dname. Earlier you have requested for $bgroup Blood Group. So, my blood group is $bgroup, and I like to donate blood. If you need, contact me.\nThankyou!!\nContact No: $contact\nAddress: $address $state $city";
			                        ...
			                        <div class="modal-footer">
			                          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
											...
											<td>
												...
												<input type="submit" onclick="return confirm('Do you really want to send message')" name="donate_btn" value="Donate" class="btn btn-primary" />
												</form>
											</td>
  										</tr>
  										<?php
