...
<html lang="en">
  <head>
    ...
    <title>About Us | Life Source Blood Bank</title>
      ...
      <div class="container-sm">
        ...
        <div class="row">                                   <!--content-->
          ...
          <div class="col-lg-8 nopadding">
            ...
            <?php
            $query34 = "SELECT * from tblpages WHERE type='aboutus'";
            $query_run34 = mysqli_query($conn,$query34);

            if (mysqli_num_rows($query_run34) > 0) {
              while ($row34 = mysqli_fetch_assoc($query_run34)) {
                echo $row34['detail'];
              }
            }
            ?>
